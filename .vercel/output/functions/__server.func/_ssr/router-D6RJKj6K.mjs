...
//#region node_modules/.nitro/vite/services/ssr/assets/router-D6RJKj6K.js
...
var styles_default = "/assets/styles--ghS2Tje.css";
var APP_NAME = "探索你的領袖特質";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "10 個大學生活情境，看看你最自然的領導方式。淡江大學領袖社招生互動測驗。"
			}
		],
		links: [
			{
...
var $$splitComponentImporter = () => import("./routes-DxETwyO-.mjs");
